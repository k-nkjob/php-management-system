...
https://knkjob-pms.infinityfree.io/

公開環境は管理データを保護するためログイン認証を設定しています。ソースコード、設計、セキュリティ対策、テスト内容は本READMEとリポジトリ内で確認できます。

## 公開環境での確認

InfinityFreeのPHP／MySQL環境へ公開し、次の操作を実ブラウザで確認しています。
